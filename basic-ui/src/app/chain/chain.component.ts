...
export class ChainComponent {
  ...
  width = 960;
  height = 600;
  colorArray:string[] = ["#007ab4", "#007ab4", "#007ab4", "#007ab4", "#007ab4", "#007ab4", "#007ab4", "#007ab4", "#007ab4", "#007ab4" ];
 //colors = d3.scaleOrdinal(d3.schemeCategory10);
 colors = d3.scaleOrdinal(this.colorArray);
  ...
  nodeNames:string[] = ["Buyer [Status: COMPLETED]", "Retailer", "Manufacturer", "Designer", "Supplier", "Vendor","Artisan", "Packager","Tailors","Reciever","Quality Inspector"];
  lastNodeId = 5;
  // only respond once per keydown
  lastKeyDown = -1;

  nodes = [
    { id: this.nodeNames[0], reflexive: false },
    { id: this.nodeNames[1], reflexive: true },
    { id: this.nodeNames[2], reflexive: false },
    { id: this.nodeNames[3], reflexive: false },
    { id: this.nodeNames[4], reflexive: false },
    { id: this.nodeNames[5], reflexive: false }
  ];
  links = [
  ...
  mousedown(dataItem: any, value: any, source: any) {
    ...
    if(this.lastNodeId + 1 == 11)
        this.lastNodeId = 1;

    const node = { id: this.nodeNames[++this.lastNodeId], reflexive: false, x: point[0], y: point[1] };
