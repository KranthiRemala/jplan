...
import { Trade } from '../jda.test.tutorialNetwork';
import 'rxjs/Rx';
...
export class TradeService {
  ...
  private ledgerUrl = "http://localhost:3000/api/Trade";

  constructor(private dataService: DataService<Trade>, private client: HttpClient) {
  };
  ...
  public getLedger() {
    return this.client.get(this.ledgerUrl);
  } 
